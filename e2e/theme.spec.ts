...
test.describe("Theme switching", () => {
  ...
  // The theme dropdown itself only renders at sm (640px) and up — the top
  // bar hides it below that (see topbar.tsx: "hidden ... sm:flex"), so
  // these tests can't run at the mobile project's 360px viewport.
