...
- [`docs/RESPONSIVE-LISTS.md`](docs/RESPONSIVE-LISTS.md) — how lists become compact rows on a phone and stay tables on a desktop, the shared ⋮ row menu with its confirm-before-remove dialog, and how drawers fit a phone screen. Ends with recipes like "turn another table into a compact list".
